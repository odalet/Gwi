...
#pragma warning disable IDE1006 // Naming Styles
    ...
    public static class QCOMOverloads
    {
        ...
        // FramebufferFoveationConfigQCOM overloads

        // Generated by Gwi.OpenGL.BindingGenerator.Parsing.SpanAndArrayOverloader
        public static unsafe void FramebufferFoveationConfigQCOM(this GL.QCOMExtension glInstance, FramebufferHandle framebuffer, uint numLayers, uint focalPointsPerLayer, uint requestedFeatures, Span<uint> providedFeatures)
        {
            fixed (uint* providedFeatures_ptr = providedFeatures) // SpanOrArrayLayer
            {
                glInstance.FramebufferFoveationConfigQCOM(framebuffer, numLayers, focalPointsPerLayer, requestedFeatures, providedFeatures_ptr);
            }
        }

        // Generated by Gwi.OpenGL.BindingGenerator.Parsing.SpanAndArrayOverloader
        public static unsafe void FramebufferFoveationConfigQCOM(this GL.QCOMExtension glInstance, FramebufferHandle framebuffer, uint numLayers, uint focalPointsPerLayer, uint requestedFeatures, uint[] providedFeatures)
        {
            fixed (uint* providedFeatures_ptr = providedFeatures) // SpanOrArrayLayer
            {
                glInstance.FramebufferFoveationConfigQCOM(framebuffer, numLayers, focalPointsPerLayer, requestedFeatures, providedFeatures_ptr);
        ...
        // Generated by Gwi.OpenGL.BindingGenerator.Parsing.RefInsteadOfPointerOverloader
        public static unsafe void FramebufferFoveationConfigQCOM(this GL.QCOMExtension glInstance, FramebufferHandle framebuffer, uint numLayers, uint focalPointsPerLayer, uint requestedFeatures, ref uint providedFeatures)
        {
            fixed (uint* providedFeatures_ptr = &providedFeatures) // RefInsteadOfPointerLayer
            {
                glInstance.FramebufferFoveationConfigQCOM(framebuffer, numLayers, focalPointsPerLayer, requestedFeatures, providedFeatures_ptr);
            }
        }
