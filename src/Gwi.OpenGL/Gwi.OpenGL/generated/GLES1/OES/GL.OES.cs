...
#pragma warning disable IDE1006 // Naming Styles
    ...
    unsafe partial class GL
    {
        ...
        public sealed unsafe partial class OESExtension
        {
            ...
            public void BlendEquationSeparateOES(BlendEquationModeEXT modeRGB, BlendEquationModeEXT modeAlpha) => ((delegate* unmanaged[Cdecl]<BlendEquationModeEXT, BlendEquationModeEXT, void>)vtable.glBlendEquationSeparateOES)(modeRGB, modeAlpha);
            public void BlendFuncSeparateOES(BlendingFactor srcRGB, BlendingFactor dstRGB, BlendingFactor srcAlpha, BlendingFactor dstAlpha) => ((delegate* unmanaged[Cdecl]<BlendingFactor, BlendingFactor, BlendingFactor, BlendingFactor, void>)vtable.glBlendFuncSeparateOES)(srcRGB, dstRGB, srcAlpha, dstAlpha);
            public void BlendEquationOES(BlendEquationModeEXT mode) => ((delegate* unmanaged[Cdecl]<BlendEquationModeEXT, void>)vtable.glBlendEquationOES)(mode);
            ...
            public void DrawTexsOES(short x, short y, short z, short width, short height) => ((delegate* unmanaged[Cdecl]<short, short, short, short, short, void>)vtable.glDrawTexsOES)(x, y, z, width, height);
            public void DrawTexiOES(int x, int y, int z, int width, int height) => ((delegate* unmanaged[Cdecl]<int, int, int, int, int, void>)vtable.glDrawTexiOES)(x, y, z, width, height);
            public void DrawTexxOES(int x, int y, int z, int width, int height) => ((delegate* unmanaged[Cdecl]<int, int, int, int, int, void>)vtable.glDrawTexxOES)(x, y, z, width, height);
            public void DrawTexsvOES(short* coords) => ((delegate* unmanaged[Cdecl]<short*, void>)vtable.glDrawTexsvOES)(coords);
            public void DrawTexivOES(int* coords) => ((delegate* unmanaged[Cdecl]<int*, void>)vtable.glDrawTexivOES)(coords);
            public void DrawTexxvOES(int* coords) => ((delegate* unmanaged[Cdecl]<int*, void>)vtable.glDrawTexxvOES)(coords);
            public void DrawTexfOES(float x, float y, float z, float width, float height) => ((delegate* unmanaged[Cdecl]<float, float, float, float, float, void>)vtable.glDrawTexfOES)(x, y, z, width, height);
            public void DrawTexfvOES(float* coords) => ((delegate* unmanaged[Cdecl]<float*, void>)vtable.glDrawTexfvOES)(coords);
            ...
            public byte IsRenderbufferOES(RenderbufferHandle renderbuffer) => ((delegate* unmanaged[Cdecl]<RenderbufferHandle, byte>)vtable.glIsRenderbufferOES)(renderbuffer);
            public void BindRenderbufferOES(RenderbufferTarget target, RenderbufferHandle renderbuffer) => ((delegate* unmanaged[Cdecl]<RenderbufferTarget, RenderbufferHandle, void>)vtable.glBindRenderbufferOES)(target, renderbuffer);
            public void DeleteRenderbuffersOES(int n, RenderbufferHandle* renderbuffers) => ((delegate* unmanaged[Cdecl]<int, RenderbufferHandle*, void>)vtable.glDeleteRenderbuffersOES)(n, renderbuffers);
            public void GenRenderbuffersOES(int n, RenderbufferHandle* renderbuffers) => ((delegate* unmanaged[Cdecl]<int, RenderbufferHandle*, void>)vtable.glGenRenderbuffersOES)(n, renderbuffers);
            public void RenderbufferStorageOES(RenderbufferTarget target, InternalFormat internalformat, int width, int height) => ((delegate* unmanaged[Cdecl]<RenderbufferTarget, InternalFormat, int, int, void>)vtable.glRenderbufferStorageOES)(target, internalformat, width, height);
            public void GetRenderbufferParameterivOES(RenderbufferTarget target, RenderbufferParameterName pname, int* parameters) => ((delegate* unmanaged[Cdecl]<RenderbufferTarget, RenderbufferParameterName, int*, void>)vtable.glGetRenderbufferParameterivOES)(target, pname, parameters);
            public byte IsFramebufferOES(FramebufferHandle framebuffer) => ((delegate* unmanaged[Cdecl]<FramebufferHandle, byte>)vtable.glIsFramebufferOES)(framebuffer);
            public void BindFramebufferOES(FramebufferTarget target, FramebufferHandle framebuffer) => ((delegate* unmanaged[Cdecl]<FramebufferTarget, FramebufferHandle, void>)vtable.glBindFramebufferOES)(target, framebuffer);
            public void DeleteFramebuffersOES(int n, FramebufferHandle* framebuffers) => ((delegate* unmanaged[Cdecl]<int, FramebufferHandle*, void>)vtable.glDeleteFramebuffersOES)(n, framebuffers);
            public void GenFramebuffersOES(int n, FramebufferHandle* framebuffers) => ((delegate* unmanaged[Cdecl]<int, FramebufferHandle*, void>)vtable.glGenFramebuffersOES)(n, framebuffers);
            public FramebufferStatus CheckFramebufferStatusOES(FramebufferTarget target) => ((delegate* unmanaged[Cdecl]<FramebufferTarget, FramebufferStatus>)vtable.glCheckFramebufferStatusOES)(target);
            public void FramebufferRenderbufferOES(FramebufferTarget target, FramebufferAttachment attachment, RenderbufferTarget renderbuffertarget, RenderbufferHandle renderbuffer) => ((delegate* unmanaged[Cdecl]<FramebufferTarget, FramebufferAttachment, RenderbufferTarget, RenderbufferHandle, void>)vtable.glFramebufferRenderbufferOES)(target, attachment, renderbuffertarget, renderbuffer);
            public void FramebufferTexture2DOES(FramebufferTarget target, FramebufferAttachment attachment, TextureTarget textarget, TextureHandle texture, int level) => ((delegate* unmanaged[Cdecl]<FramebufferTarget, FramebufferAttachment, TextureTarget, TextureHandle, int, void>)vtable.glFramebufferTexture2DOES)(target, attachment, textarget, texture, level);
            public void GetFramebufferAttachmentParameterivOES(FramebufferTarget target, FramebufferAttachment attachment, FramebufferAttachmentParameterName pname, int* parameters) => ((delegate* unmanaged[Cdecl]<FramebufferTarget, FramebufferAttachment, FramebufferAttachmentParameterName, int*, void>)vtable.glGetFramebufferAttachmentParameterivOES)(target, attachment, pname, parameters);
            public void GenerateMipmapOES(TextureTarget target) => ((delegate* unmanaged[Cdecl]<TextureTarget, void>)vtable.glGenerateMipmapOES)(target);
            ...
            public void CurrentPaletteMatrixOES(uint matrixpaletteindex) => ((delegate* unmanaged[Cdecl]<uint, void>)vtable.glCurrentPaletteMatrixOES)(matrixpaletteindex);
            public void LoadPaletteFromModelViewMatrixOES() => ((delegate* unmanaged[Cdecl]<void>)vtable.glLoadPaletteFromModelViewMatrixOES)();
            public void MatrixIndexPointerOES(int size, MatrixIndexPointerTypeARB type, int stride, void* pointer) => ((delegate* unmanaged[Cdecl]<int, MatrixIndexPointerTypeARB, int, void*, void>)vtable.glMatrixIndexPointerOES)(size, type, stride, pointer);
            public void WeightPointerOES(int size, GLEnum type, int stride, void* pointer) => ((delegate* unmanaged[Cdecl]<int, GLEnum, int, void*, void>)vtable.glWeightPointerOES)(size, type, stride, pointer);
            public void PointSizePointerOES(GLEnum type, int stride, void* pointer) => ((delegate* unmanaged[Cdecl]<GLEnum, int, void*, void>)vtable.glPointSizePointerOES)(type, stride, pointer);
            ...
            public void TexGenfOES(TextureCoordName coord, TextureGenParameter pname, float param) => ((delegate* unmanaged[Cdecl]<TextureCoordName, TextureGenParameter, float, void>)vtable.glTexGenfOES)(coord, pname, param);
            public void TexGenfvOES(TextureCoordName coord, TextureGenParameter pname, float* parameters) => ((delegate* unmanaged[Cdecl]<TextureCoordName, TextureGenParameter, float*, void>)vtable.glTexGenfvOES)(coord, pname, parameters);
            public void TexGeniOES(TextureCoordName coord, TextureGenParameter pname, int param) => ((delegate* unmanaged[Cdecl]<TextureCoordName, TextureGenParameter, int, void>)vtable.glTexGeniOES)(coord, pname, param);
            public void TexGenivOES(TextureCoordName coord, TextureGenParameter pname, int* parameters) => ((delegate* unmanaged[Cdecl]<TextureCoordName, TextureGenParameter, int*, void>)vtable.glTexGenivOES)(coord, pname, parameters);
            public void GetTexGenfvOES(TextureCoordName coord, TextureGenParameter pname, float* parameters) => ((delegate* unmanaged[Cdecl]<TextureCoordName, TextureGenParameter, float*, void>)vtable.glGetTexGenfvOES)(coord, pname, parameters);
            public void GetTexGenivOES(TextureCoordName coord, TextureGenParameter pname, int* parameters) => ((delegate* unmanaged[Cdecl]<TextureCoordName, TextureGenParameter, int*, void>)vtable.glGetTexGenivOES)(coord, pname, parameters);
